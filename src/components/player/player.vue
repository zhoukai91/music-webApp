...
import {shuffle, clearToast, detectmob} from 'common/js/util'
  ...
  methods: {
    ...
    handelLyric ({lineNum, txt}) {
      ...
      if (lineNum > 5) {
        ...
        this.$refs.lyricList.toScrollElement(this.$refs.lyricLine[0], 1000)
      }
